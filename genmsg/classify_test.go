...
// commonTag returns the addressable key (as computed by describeFields) of the
...
func TestSelectFieldsNoDuplicateWhenAlreadySelected(t *testing.T) {
	// A field that's already Required (or otherwise in generatableFields's base
