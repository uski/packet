...
// Apply creates a new draft message in inc for each Result, setting its
...
func Apply(inc *incident.Incident, msgtype message.EditableMType, results []Result) (ids []string, incomplete []Result, err error) {
